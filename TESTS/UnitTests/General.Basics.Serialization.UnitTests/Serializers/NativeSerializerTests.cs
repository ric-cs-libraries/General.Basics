...
using General.Basics.Serialization.Serializers;


namespace General.Basics.Serialization.Serializers.UnitTests;
...
public class NativeSerializerTests
{
    ...
    {
        ISerializer s1 = NativeSerializer.Create();
        ISerializer s2 = NativeSerializer.Create();
