...
public class AssemblyExtensionTests
{
    ...
    public void GetInstancesFromClassesImplementing_WhenProvidedTypeIsNotAnInterfaceType_ShouldThrowATypeShouldBeAnInterfaceTypeException()
    {
        ...
        var expectedMessage = string.Format(ReflectionExtended.POO.Abstracts.TypeShouldBeException.MESSAGE_FORMAT, typeof(Vehicle).GetFullName_(), TypeShouldBeAnInterfaceTypeException.EXPECTED_TYPE_LABEL);
    ...
    public void GetInstancesFromGenericClassesImplementing_WhenProvidedTypeIsNotAnInterfaceType_ShouldThrowATypeShouldBeAnInterfaceTypeException()
    {
        ...
        var expectedMessage = string.Format(ReflectionExtended.POO.Abstracts.TypeShouldBeException.MESSAGE_FORMAT, typeof(Vehicle<int>).GetFullName_(), TypeShouldBeAnInterfaceTypeException.EXPECTED_TYPE_LABEL);
        Assert.Equal(expectedMessage, ex.Message);
    }
