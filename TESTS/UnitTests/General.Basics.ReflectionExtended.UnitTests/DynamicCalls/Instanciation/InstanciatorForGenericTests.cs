...
public class InstanciatorForGenericTests
{
    ...
    public void GetInstance_WhenCalledForAnAbstractType_ShouldThrowAnAnAbstractTypeCannotBeInstanciatedException()
    {
        ...
        var typeFullName1 = $"{@namespace}.{className1}{GENERIC_TYPES_NAME_SEPARATOR_SYMBOL}{genericParametersType.Length}";
        var typeFullName2 = $"{@namespace}.{className2}{GENERIC_TYPES_NAME_SEPARATOR_SYMBOL}{genericParametersType.Length}";
